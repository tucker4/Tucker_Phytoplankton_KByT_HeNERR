...
anvi-run-ncbi-cogs --cog-data-dir /tank/tucker_data/ANVIO_NCBI_COGS_2020 -c cyano-CONTIGS.db --num-threads 20
...
for sample in `awk '{print $1}' /tank/tucker_data/KByT_Mende/samples_Aloha_KByT_mende_v2.txt`
do
