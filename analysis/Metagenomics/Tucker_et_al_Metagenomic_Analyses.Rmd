...
```{python}
anvi-compute-genome-similarity --internal-genomes cyanoApril2024_internal_genomes.txt --program fastANI --output-dir Cyano-April-ANI --num-threads 40 -p cyanoApril2024-PAN/cyanoApril2024-PAN-PAN.db
#you will need the fastANI_ani.txt to bring into R
```
